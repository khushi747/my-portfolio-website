	...
	theme: {
		...
		extend: {
			colors: {
				...
				'pastel-primary': 'hsl(var(--pastel-primary))',
				'pastel-secondary': 'hsl(var(--pastel-secondary))',
				'pastel-blue': 'hsl(var(--pastel-blue))',
				'pastel-cyan': 'hsl(var(--pastel-cyan))',
				'pastel-green': 'hsl(var(--pastel-green))',
				'pastel-emerald': 'hsl(var(--pastel-emerald))',
				...
				'pastel-indigo': 'hsl(var(--pastel-indigo))'
			},
			borderRadius: {
				lg: 'var(--radius)',
